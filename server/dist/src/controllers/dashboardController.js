...
const getDashboardMetrics = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const expenseByCategorySummary = expenseByCategorySummaryRaw.map((index) => (Object.assign(Object.assign({}, index), { amount: index.amount.toString() })));
        res.json({
            popularProducts,
            salesSummary,
            purchaseSummary,
        ...
        res
            .status(500)
            .json({ message: "Error retreiving dashboard metrics" });
    }
});
